...
def create_db_connection(app_config):
    ...
    try:
        ...
        return None
#dsdsfddffddfdfdfdsdsdgfgfdfdfdfgfgdfhghghghghgdfdfcomment test nddsdsdsdsdssdssdsdsdsdefdfdfdsdsdsdsddfdsdsdsdfdfdfdsdsdsdsdsdsfdfdredsdsdssdsreedsdsdsdsdshjhdshkjsd
